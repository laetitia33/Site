...
<div class="oneServDetail">
    ...
    <p>
        ...
        <!--formulaire de modification des serices-->

        <form class="form"
            action="index.php?action=updatePost&amp;post_id=<?= $_GET['post_id'];?>#films"
            method="POST">
            <div
            ...
            <div>
                ...
                <input type="text"
                    name="author"
                    class="inputbasic"
                    title='Veuillez entrer un auteur'
                    id="author" value="<?php
            ...
            <div>
                ...
                <input type="text"
                    ...
                    class="inputbasic"
                    id="image"
                    title='Veuillez entrer une image'
            ...
            <div class="inputbasic">
                ...
                <textarea class="editme"
                    name="content"
                    title='Veuillez entrer un résumé'
                    id="content"><p><?= htmlspecialchars_decode(nl2br(html_entity_decode($post['content'])));?></p></textarea>
