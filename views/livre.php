...
<!--///////////////presentation site coté gauche/////////-->
<div id="volet_clos">
    <div id="volet">
        <p>Par téléphone au <br> <i
                class="fas fa-phone-volume"></i><a
                href="tel:+0659982720">
                06 59 98 27 20
            </a><br>du lundi au samedi
            de 8h à 19h <br>sans
            interruption ou par <br><i
                class="fas fa-envelope"></i>
            <a
                href="index.php?action=email">E-mail</a>
        </p>
        <a href="#volet" class="ouvrir"
            aria-hidden="true">Contact
        </a>
        <a href="#volet_clos"
            class="fermer"
            aria-hidden="true">fermer
        </a>
    </div>
</div>
...
<div class='listcom'><a
        href="index.php?action=deleteCommentsLivreGold"
        class="deletecommAll"><i
            class="fas fa-minus-circle">
            Supprimer tous les messsages
        </i></a></div>
<?php
endif;
?>
...
<div class="book">
    <div class="paper">
        ...
        <div class="paperCorner">
            <div
                class="paperCornerClip">
            </div>
            <div
                class="paperCornerBackground">
            </div>
        </div>
        <div id="paperContent">
            <div
                class="paperContentPage1">
                <?php
...
/////////////////////////-écrire commentaires admin ou utilisateur //////////////////////////-->
                ...
                <form class='form'
                    action="index.php?action=addComment#ancrecom"
                    method="POST">
                ...
                <em
                    style="color:black;font-size:1.5em"><i
                        class="fas fa-ban"></i>
                    Vous devez être <a
                        id='validcom'
                        href="index.php?action=login">connecté
                    </a><br>pour laisser
                    un message</em><br>
            ...
            <div
                ...
                <div class="pag">
                    <a href="javascript:void(0)"
                        class="list-group-item active"></a>
                    <hr
                        class='hrReponse'>
                    <h3><strong><i
                                class="fas fa-user"></i>
                    ...
                    <div class="coms">
                        <span
                            id="confirmsignal">
                            <p><?= nl2br(preg_replace('#^<br/>$#','',htmlspecialchars(substr($comment['comment'], 0, 400))));
                            ?></p>
                        </span>
                    </div>
                    ...
                    <div
                        class="reponse">
                        <em><a href="index.php?action=deleteCommentGold&amp;id=<?= $comment['id'];?>"
                                class='deletecomm'>Supprimer&nbsp;<i
                                    class="fas fa-minus-circle"></i></a></em>
                        <em><a href="index.php?action=report&amp;id=<?= $comment['id']; ?>"
                                class='validcom'
                                ;"><i
                                    class="fas fa-bell">
                                    Signalez
